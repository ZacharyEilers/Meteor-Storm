...
function scene:create( event )
    ...
    local function toggleVibration()
        if (user.vibrate == true) then
            user.vibrate = false
            btn_vibrationToggle.alpha = 0.3
         else
            user.vibrate = true
            btn_vibrationToggle.alpha = 1
        end
    ...
    btn_vibrationToggle = widget.newButton {
        width = 1087,
        height = 260,
        defaultFile = "images/settingsScreen/btn_toggleVibration.png",
        overFile = "images/settingsScreen/btn_toggleVibrationOver.png",
        onRelease = toggleVibration
    }

        btn_vibrationToggle:scale(0.2, 0.2)
        btn_vibrationToggle.x = leftScreen + btn_vibrationToggle.width/5/1.5
        btn_vibrationToggle.y = centerY - btn_vibrationToggle.height/5/2
        sceneGroup:insert(btn_vibrationToggle)
